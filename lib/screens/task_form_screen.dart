...
class _TaskFormScreenState extends State<TaskFormScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return AppPageScaffold(
      ...
      subtitle: '标题、时间、提醒和分类',
      leadingIcon: isEditing ? Icons.edit_note : Icons.add_task,
      actions: [
        FilledButton.tonal(onPressed: _saveTask, child: const Text('保存')),
      ],
      child: Form(
        key: _formKey,
        child: ListView(
          ...
          children: [
            AppFormSection(
              title: '核心信息',
              subtitle: '任务标题是唯一必填项，也可以先写一句完整描述再交给 AI 识别。',
